    ...
    return ( 
        <>
            {!displayPopUp ? <Form action={formAction} className="max-w-[400px] mx-auto mt-10 max-h-screen overflow-hidden">
                <label htmlFor="routine-name" className="max-[657px]:text-[14px]">Routine Name:</label>
                <Input className="w-full" type="text" name="routine-name" id="routine-name" placeholder="E.g: Push Day" value={routineName} onChange={e => setRoutineName(e.target.value)} required/>
